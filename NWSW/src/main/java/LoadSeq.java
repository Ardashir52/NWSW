...
public class LoadSeq {
    ...
    public LoadSeq(String path1, String path2) throws IOException {
        ...
        seq1 = readSequence(new BufferedReader(new FileReader(f)));
        f = new File(path2);
        seq2 = readSequence(new BufferedReader(new FileReader(f)));
    }

    public LoadSeq(InputStream in1, InputStream in2) throws IOException {
        seq1 = readSequence(new BufferedReader(new InputStreamReader(in1)));
        seq2 = readSequence(new BufferedReader(new InputStreamReader(in2)));
    }
